...
Compiled from docs/01 through docs/18.
...
# Counsly — Introduction & Philosophy
...
# Counsly — Counselling Round Logic
...
| Map load | < 3s for 466 pins on 4G |
| Paywall → CTA | > 30% |
