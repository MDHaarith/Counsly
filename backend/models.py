...
class College(Base):
    ...
    nearest_railway_station_latitude = Column(Float)
    nearest_railway_station_longitude = Column(Float)
    nearest_railway_distance_km = Column(Float)
    nearest_express_station = Column(String(150))
    nearest_express_station_latitude = Column(Float)
    nearest_express_station_longitude = Column(Float)
    nearest_express_station_distance_km = Column(Float)
    nearest_bus_station = Column(String(150))
    nearest_bus_station_latitude = Column(Float)
    nearest_bus_station_longitude = Column(Float)
    nearest_bus_station_distance_km = Column(Float)
    nearest_bus_stop = Column(String(150))
    nearest_bus_stop_latitude = Column(Float)
    nearest_bus_stop_longitude = Column(Float)
    nearest_bus_stop_distance_km = Column(Float)
