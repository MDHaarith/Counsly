...
GEOCODER="$SCRIPT_DIR/google_maps_coords_v2.py"
VALIDATOR="$SCRIPT_DIR/validate_google_maps_coords_v2.py"
REVIEWER="$SCRIPT_DIR/final_review_google_maps_coords_v2.py"
