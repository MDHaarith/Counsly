...
This file replaces the older launch-planning notes with the **actual extracted data and schemas** currently available in `supabase_db/Data_Extractor`.
...
**Status:** Present and now extracted into a structured geo dataset with Google Maps support.

**Source file:**
- `TFC/7_List_of_TFCs.pdf`

**Structured outputs:**
- `TFC/tfc_locations.json`
- `TFC/tfc_locations.csv`
- `TFC/tfc_locations_unresolved.json`

**Extractor implementation:**
- `TFC/extract_tfc_locations.py`

**Row counts:**
- Total TFC rows extracted: `110`
- Resolved geo rows: `110`
- Unresolved geo rows: `0`

**Coverage:**
- TNEA Facilitation Centers listed in the 2025 PDF across districts in Tamil Nadu
...
**Notes:**
- This is now the current structured source for TFC discovery and nearest-TFC style lookup.
- `google_maps_url` is included so users can open each TFC directly in Google Maps.
- Coordinates were generated during extraction and stored alongside the original address text.
...
| TFC geo locations | `TFC/tfc_locations.json` | `tfc_locations` |
...
- TFC geo locations (`110` rows, with Google Maps links)
